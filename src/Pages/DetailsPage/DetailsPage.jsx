...
//   useEffect(() => {
//     // Assuming your data.json is in the public folder
//     fetch(`/data.json`)
...
//                       <li className="list-disc about-desc">{service}</li>
//                     ))}
//                   </ul>
//                 </div>
//                 <div className="">
...
//                       <li className="list-disc about-desc">{benefit}</li>
//                     ))}
//                   </ul>
//                 </div>
//               </div>
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setSelectedResult(fetchedData); // Update the state with fetched data
      } catch (error) {
        console.error("Error fetching data:", error);
